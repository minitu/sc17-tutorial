...
class Main: public CBase_Main {
  ...
  public:
    ...
    /*
     * Add reduction target entry methods, one for sum and one for max.
     * The parameter passed to the function will be the reduced number of
     * particles. Use CkPrintf to print the numbers.
     * Hint: don't forget to edit the .ci file as well!
     */
    // TODO
...
class Cell: public CBase_Cell {
  ...
  private:
    /*
     * Use 'contribute' calls to perform 2 reductions (order does not matter):
     * 1. Total number of particles in all cells (CkReduction::sum_int)
     * 2. Maximum number of particles in a cell (CkReduction::max_int)
     */
    void reduce() {
      // TODO
    }
